...
module.exports = class ProofPurpose {
  ...
  validate(proof, {
    ...
    return _asyncToGenerator(function* () {
      try {
        // check expiration
        if (_this.maxTimestampDelta !== Infinity) {
          const expected = (_this.date || new Date()).getTime();
          const delta = _this.maxTimestampDelta * 1000;
  ...
  update(proof, {
    ...
    return _asyncToGenerator(function* () {
      proof.proofPurpose = _this2.term;
      return proof;
    })();
  }
  /**
  ...
  match(proof, {
    ...
    return _asyncToGenerator(function* () {
      return proof.proofPurpose === _this3.term;
    })();
  }
