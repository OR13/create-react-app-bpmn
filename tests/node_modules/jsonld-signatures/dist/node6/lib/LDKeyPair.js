  ...
  if (env.nodejs) {
    ...
    return {
      sign({
        ...
        return _asyncToGenerator(function* () {
          return chloride.crypto_sign_detached(Buffer.from(data.buffer, data.byteOffset, data.length), privateKey);
        })();
      }
  ...
  if (env.nodejs) {
    ...
    return {
      verify({
        ...
        return _asyncToGenerator(function* () {
          return chloride.crypto_sign_verify_detached(Buffer.from(signature.buffer, signature.byteOffset, signature.length), Buffer.from(data.buffer, data.byteOffset, data.length), publicKey);
        })();
      }
